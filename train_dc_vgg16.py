...
with mirrored_strategy.scope():
    ...
    base_model = tf.keras.applications.VGG16(input_shape=(img_width, img_height, 3),
                                                   include_top=False,
                                                   weights='imagenet')
...
model.save('document_classifier_model_3.h5')  # always save your weights after training or during training